...
class VHA_Hubbard_1p(VariationalForm):
    """
    VHA_Hubbard_1p
    """
    ...
    CONFIGURATION = {
        'name': 'VHA_Hubbard_1p',
        'description': 'VHA_Hubbard_1p Variational Form',
        'input_schema': {
        ...
        for block in range(self._depth):
            ...
            if self._drive:
                ...
                if self._more_drive_params is False:
                    drive_params = np.array([params_for_this_block[0],params_for_this_block[0]]*Nsite)

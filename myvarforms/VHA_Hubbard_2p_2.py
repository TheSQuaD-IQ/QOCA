...
class VHA_Hubbard_2p_2(VariationalForm):
    """
    VHA_Hubbard_2p_2
    """

    CONFIGURATION = {
        'name': 'VHA_Hubbard_2p_2',
        'description': 'VHA_Hubbard_2p_2 Variational Form',
        'input_schema': {
    ...
    def construct_circuit(self, parameters, q=None):
        ...
        for block in range(self._depth):
            ...
            if self._more_VHA_params is False:
                ...
                T_params = self._num_T_terms * [params_for_this_block[0]]
                # idx = 0
            ...
            if self._drive:
                ...
                if self._more_drive_params is False:
                    drive_params = np.array([params_for_this_block[-1],params_for_this_block[-1]]*Nsite)

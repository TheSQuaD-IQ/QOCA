...
class VHA_Hubbard_2p_3(VariationalForm):
    """
    VHA_Hubbard_2p_3
    """

    CONFIGURATION = {
        'name': 'VHA_Hubbard_2p_3',
        'description': 'VHA_Hubbard_2p_3 Variational Form',
        'input_schema': {
    ...
    def construct_circuit(self, parameters, q=None):
        ...
        for block in range(self._depth):
            ...
            if self._more_VHA_params is False:
                ...
                V_params = self._num_V_terms * [0.18367346938775508]
                T_params = self._num_T_terms * [0.19387755102040816]
                # idx = 0
            ...
            if self._drive:
                ...
                if self._more_drive_params is False:
                    drive_params = np.array([params_for_this_block[0],params_for_this_block[1]]*Nsite)
